...
_0x12:
	BLD  R2,1
; 0000 0030 if((botonp==1)&&(botona==0)){
	SBRS R2,0
	RJMP _0x8
	SBRS R2,1
	RJMP _0x9
...
; 0000 0033 var=9;
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 0034 delay_ms(40);
_0xA:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0035 }
; 0000 0036 if((botonp==0)&&(botona==1))
_0x7:
	SBRC R2,0
	RJMP _0xC
	SBRC R2,1
...
_0xC:
	RJMP _0xB
_0xD:
; 0000 0037 delay_ms(40);
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0038 botonp=botona;
_0xB:
	BST  R2,1
	BLD  R2,0
; 0000 0039 }
...
; 0000 0054 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0055 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=P Bit2=T Bit1=T Bit0=T
; 0000 0056 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (1<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	LDI  R30,LOW(8)
	OUT  0x12,R30
; 0000 0057 
...
; 0000 0086 // INT0: On
; 0000 0087 // INT0 Mode: Rising Edge
; 0000 0088 // INT1: On
; 0000 0089 // INT1 Mode: Falling Edge
; 0000 008A // INT2: Off
; 0000 008B GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 008C MCUCR=(1<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(11)
	OUT  0x35,R30
; 0000 008D MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 008E GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 008F 
...
_0xE:
; 0000 00A9       {
; 0000 00AA      PORTB=~tabla7segmentos[var];
	MOV  R30,R5
	LDI  R31,0
