...
_0x12:
	BLD  R2,1
; 0000 008E       if((botona==0)&&(botonp==1)){
	LDI  R26,0
	SBRC R2,1
	LDI  R26,1
	CPI  R26,LOW(0x0)
...
_0xD:
	...
	RCALL _delay_ms
; 0000 0099       }
; 0000 009A       if((botona==1)&&(botonp==0))
_0x9:
	SBRS R2,1
	RJMP _0xF
	LDI  R26,0
...
; 0000 009B       delay_ms(40);
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 009C       PORTB=tabla7segmentos[var1];
_0xE:
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 009D       PORTA=tabla7segmentos[var];
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x1B,R30
; 0000 009E       botonp=botona;
	BST  R2,1
	BLD  R2,0
; 0000 009F 
; 0000 00A0       }
