...
; 0000 008E       var2=0;
; 0000 008F       i=0;
; 0000 0090       PORTC=tabla7segmentos[var];
; 0000 0091       PORTA=tabla7segmentos[var1];
; 0000 0092       PORTB=tabla7segmentos[var2];
; 0000 0093       }
; 0000 0094 
; 0000 0095       if(start==0){
	SBIC 0x10,2
	RJMP _0x8
; 0000 0096       for(i=0; i<=600; i++){
	CLR  R4
	CLR  R5
_0xA:
	LDI  R30,LOW(600)
...
; 0000 00AC       l=var2;
	...
	ST   Y,R30
	STD  Y+1,R31
; 0000 00AD       PORTC=tabla7segmentos[j];
	LDD  R30,Y+4
	LDD  R31,Y+4+1
	RCALL SUBOPT_0x1
	OUT  0x15,R30
; 0000 00AE       PORTA=tabla7segmentos[k];
	LDD  R30,Y+2
	LDD  R31,Y+2+1
	RCALL SUBOPT_0x1
	OUT  0x1B,R30
; 0000 00AF       PORTB=tabla7segmentos[l];
	LD   R30,Y
	LDD  R31,Y+1
	RCALL SUBOPT_0x1
	OUT  0x18,R30
...
; 0000 00B7       var2=0;
; 0000 00B8       i=0;
; 0000 00B9       PORTC=tabla7segmentos[var];
; 0000 00BA       PORTA=tabla7segmentos[var1];
; 0000 00BB       PORTB=tabla7segmentos[var2];
; 0000 00BC       break;
	RJMP _0xB
; 0000 00BD       }
; 0000 00BE 
...
_0x10:
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 00C0       PORTC=tabla7segmentos[var];
	MOV  R30,R7
	LDI  R31,0
	RCALL SUBOPT_0x1
	OUT  0x15,R30
; 0000 00C1       PORTA=tabla7segmentos[var1];
	MOV  R30,R6
	LDI  R31,0
	RCALL SUBOPT_0x1
	OUT  0x1B,R30
; 0000 00C2       PORTB=tabla7segmentos[var2];
	MOV  R30,R9
	LDI  R31,0
	RCALL SUBOPT_0x1
	OUT  0x18,R30
...
; 0000 00C4       }
; 0000 00C5 
; 0000 00C6       //continuacion por si la riego
; 0000 00C7 
; 0000 00C8 
; 0000 00C9 
; 0000 00CA 
