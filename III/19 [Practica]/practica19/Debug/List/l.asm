...
_0x10:
	BLD  R2,1
; 0000 002E if((botonp==1)&&(botona==0)){
	SBRS R2,0
	RJMP _0x6
	SBRS R2,1
	RJMP _0x7
...
; 0000 0031 var=0;
	CLR  R4
	CLR  R5
; 0000 0032 delay_ms(40);
_0x8:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0033 }
; 0000 0034 if ((botonp==0)&&(botona==1))
_0x5:
	SBRC R2,0
	RJMP _0xA
	SBRC R2,1
...
; 0000 0051 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0052 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=P Bit2=T Bit1=T Bit0=T
; 0000 0053 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (1<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	LDI  R30,LOW(8)
	OUT  0x12,R30
; 0000 0054 
...
; 0000 0083 // INT0: On
; 0000 0084 // INT0 Mode: Low level
; 0000 0085 // INT1: On
; 0000 0086 // INT1 Mode: Falling Edge
; 0000 0087 // INT2: Off
; 0000 0088 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0089 MCUCR=(1<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(8)
	OUT  0x35,R30
; 0000 008A MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 008B GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 008C 
...
; 0000 00A4 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 00A5 
; 0000 00A6 // Globally enable interrupts
; 0000 00A7 #asm("sei")
	SEI
; 0000 00A8 
; 0000 00A9 while (1)
...
; 0000 00AC       PORTB=~tabla7segmentos[var];
	MOVW R30,R4
