...
; 0000 0088 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0089 
; 0000 008A if(datoaguardar>10)
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	CPI  R30,LOW(0xB)
	BRLO _0x4
; 0000 008B datoaguardar=0;
	RCALL SUBOPT_0x0
	LDI  R30,LOW(0)
	RCALL __EEPROMWRB
; 0000 008C var=datoaguardar;
_0x4:
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	MOV  R5,R30
...
; 0000 0091         PORTB=tabla7segmentos[var];
	...
	LD   R30,Z
	OUT  0x18,R30
; 0000 0092         if(boton_guarda==0)
	SBIC 0x13,1
	RJMP _0x8
; 0000 0093         datoaguardar=var;
	MOV  R30,R5
	RCALL SUBOPT_0x0
	RCALL __EEPROMWRB
; 0000 0094       };
...
;
;void checa_boton(void){
; 0000 0097 void checa_boton(void){
_checa_boton:
; .FSTART _checa_boton
; 0000 0098 
...
_0x13:
	BLD  R2,1
; 0000 009D if((botonp==1)&&(botona==0))
	SBRS R2,0
	RJMP _0xD
	LDI  R26,0
	SBRC R2,1
...
; 0000 00A1 var=0;
	CLR  R5
; 0000 00A2 delay_ms(40);
_0xF:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A3 }
; 0000 00A4 if((botonp==0)&&(botona==1))
_0xC:
	LDI  R26,0
	SBRC R2,0
	LDI  R26,1
