...
;const char tabla7segmentos[17]={0x3f,0x06,0x5b,0x4f,0x66,0x6d,0x7c,0x07,0x7f,0x6f,0x77,0x7f,0x39,0x3f,0x79,0x71,0x7d};
...
; 0000 0033 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(240)
	OUT  0x15,R30
; 0000 0034 
...
_0x4:
; 0000 0085       {
; 0000 0086       //se prueba la primera columna se envia 1110
; 0000 0087       PORTC=0b11111110;
	LDI  R30,LOW(254)
	RCALL SUBOPT_0x0
; 0000 0088 
; 0000 0089       lectura=PINC&0b11110000;
; 0000 008A       if(lectura==0b11100000)
	BRNE _0x7
; 0000 008B       tecla=13;
	LDI  R30,LOW(13)
	MOV  R5,R30
; 0000 008C       if(lectura==0b11010000)
_0x7:
	RCALL SUBOPT_0x1
	BRNE _0x8
; 0000 008D       tecla=14;
	LDI  R30,LOW(14)
	MOV  R5,R30
; 0000 008E       if(lectura==0b10110000)
_0x8:
	RCALL SUBOPT_0x2
	BRNE _0x9
; 0000 008F       tecla=15;
	LDI  R30,LOW(15)
	MOV  R5,R30
; 0000 0090       if(lectura==0b01110000)
_0x9:
	RCALL SUBOPT_0x3
	BRNE _0xA
; 0000 0091       tecla=16;
	...
	MOV  R5,R30
; 0000 0092 
; 0000 0093       //se prueba la segunda columna se envia 1101
; 0000 0094       PORTC=0b11111101;
_0xA:
	LDI  R30,LOW(253)
	RCALL SUBOPT_0x0
; 0000 0095 
; 0000 0096       lectura=PINC&0b11110000;
; 0000 0097       if(lectura==0b11100000)
	BRNE _0xB
; 0000 0098       tecla=9;
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 0099       if(lectura==0b11010000)
_0xB:
	RCALL SUBOPT_0x1
	BRNE _0xC
; 0000 009A       tecla=10;
	LDI  R30,LOW(10)
	MOV  R5,R30
; 0000 009B       if(lectura==0b10110000)
_0xC:
	RCALL SUBOPT_0x2
	BRNE _0xD
; 0000 009C       tecla=11;
	LDI  R30,LOW(11)
	MOV  R5,R30
; 0000 009D       if(lectura==0b01110000)
_0xD:
	RCALL SUBOPT_0x3
	BRNE _0xE
; 0000 009E       tecla=12;
	...
	MOV  R5,R30
; 0000 009F 
; 0000 00A0       //se prueba la tercera columna se envia 1011
; 0000 00A1 
; 0000 00A2       PORTC=0b11111011;
_0xE:
	LDI  R30,LOW(251)
	RCALL SUBOPT_0x0
; 0000 00A3 
; 0000 00A4       lectura=PINC&0b11110000;
; 0000 00A5       if(lectura==0b11100000)
	BRNE _0xF
; 0000 00A6       tecla=5;
	LDI  R30,LOW(5)
	MOV  R5,R30
; 0000 00A7       if(lectura==0b11010000)
_0xF:
	RCALL SUBOPT_0x1
	BRNE _0x10
; 0000 00A8       tecla=6;
	LDI  R30,LOW(6)
	MOV  R5,R30
; 0000 00A9       if(lectura==0b10110000)
_0x10:
	RCALL SUBOPT_0x2
	BRNE _0x11
; 0000 00AA       tecla=7;
	LDI  R30,LOW(7)
	MOV  R5,R30
; 0000 00AB       if(lectura==0b01110000)
_0x11:
	RCALL SUBOPT_0x3
	BRNE _0x12
; 0000 00AC       tecla=8;
	...
	MOV  R5,R30
; 0000 00AD 
; 0000 00AE       //se prueba la cuarta columna se envia 0111
; 0000 00AF 
; 0000 00B0       PORTC=0b11110111;
_0x12:
	LDI  R30,LOW(247)
	RCALL SUBOPT_0x0
; 0000 00B1 
; 0000 00B2       lectura=PINC&0b11110000;
; 0000 00B3       if(lectura==0b11100000)
	BRNE _0x13
; 0000 00B4       tecla=1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 00B5       if(lectura==0b11010000)
_0x13:
	RCALL SUBOPT_0x1
	BRNE _0x14
; 0000 00B6       tecla=2;
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 00B7       if(lectura==0b10110000)
_0x14:
	RCALL SUBOPT_0x2
	BRNE _0x15
; 0000 00B8       tecla=3;
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 00B9       if(lectura==0b01110000)
_0x15:
	RCALL SUBOPT_0x3
	BRNE _0x16
; 0000 00BA       tecla=4;
	...
	MOV  R5,R30
; 0000 00BB 
; 0000 00BC       PORTB=tabla7segmentos[tecla];
_0x16:
	MOV  R30,R5
	LDI  R31,0
