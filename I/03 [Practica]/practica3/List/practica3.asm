...
; 0000 0086       variable2=PINC&0x0f;
	...
	ANDI R30,LOW(0xF)
	MOV  R4,R30
; 0000 0087       if(variable<10){
	LDI  R30,LOW(10)
	CP   R5,R30
	BRSH _0x7
; 0000 0088       PORTB=tabla7segmentos[variable];
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 0089       }
; 0000 008A       if(variable2<10){
_0x7:
	LDI  R30,LOW(10)
	CP   R4,R30
	BRSH _0x8
; 0000 008B       PORTA=~tabla7segmentos[variable2];
	MOV  R30,R4
	RCALL SUBOPT_0x0
	COM  R30
	OUT  0x1B,R30
...
; 0000 008E       PORTB=0x79;
	...
	OUT  0x18,R30
; 0000 008F       }
; 0000 0090       if(variable2>=10){
_0x9:
	LDI  R30,LOW(10)
	CP   R4,R30
	BRLO _0xA
; 0000 0091       PORTA=~0x79;
	LDI  R30,LOW(134)
	OUT  0x1B,R30
; 0000 0092       }
; 0000 0093 
